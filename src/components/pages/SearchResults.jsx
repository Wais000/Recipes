...
const SearchResults = () => {
  ...
  // No state (direct access) – centered fallback
  if (!location.state) {
    return (
  ...
  return (
    <section className="flex flex-wrap justify-center gap-4 p-8 bg-white/30 rounded-2xl mb-8">
      ...
      {meals ? (
        ...
        <div className="flex justify-center align-items-center">
          <div className="text-center py-16 px-8 bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-amber-200/50 max-w-2xl">
